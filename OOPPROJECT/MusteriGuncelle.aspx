<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="MusteriGuncelle.aspx.cs" Inherits="OOPPROJECT.MusteriGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="container" style="vertical-align:central">
        <form runat="server">
            ...
            <asp:Label ID="Label3" runat="server" Text="Müşteri Id" Font-Bold="True"></asp:Label>
            <asp:TextBox ID="TextBox3" runat="server" class="form-control" placeholder="" Enabled="false" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="form-group">
